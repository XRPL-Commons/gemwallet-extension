...
export const DIDSet: FC = () => {
  ...
  const { fetchedData } = useFetchFromSessionStorage(
    ...
    fetchedData: DIDSetRequest | undefined;
  };
  ...
  const sendMessageToBackground = useCallback(
    (message: ReceiveDIDSetBackgroundMessage) => {
  ...
  useEffect(() => {
    ...
    const transaction = buildDIDSet(
      {
        ...baseParams,
        ...(fetchedData.DIDDocument && { DIDDocument: fetchedData.DIDDocument }),
        ...(fetchedData.URI && { URI: fetchedData.URI }),
        ...(fetchedData.Data && { Data: fetchedData.Data })
      },
      wallet
    );
  ...
  const handleConfirm = useCallback(() => {
    ...
    didSet(params.transaction as DIDSetXRPL)
      .then((response) => {
  ...
  }, [params, didSet, sendMessageToBackground, createMessage]);
  ...
  return (
    <TransactionPage
      title="Set DID"
      description="Please review the DID transaction below."
