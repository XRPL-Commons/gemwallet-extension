...
export const checkCreate = async (payload: CheckCreateRequest): Promise<CheckCreateResponse> => {
  /* response:
   ...
   * - throw an error
   */
  let response: CheckCreateResponse = {
    type: ResponseType.Reject,
    result: undefined
  };

  try {
    const message: RequestCheckCreateMessage = {
      app: GEM_WALLET,
