...
export const paymentChannelFund = async (
  payload: PaymentChannelFundRequest
): Promise<PaymentChannelFundResponse> => {
  /* response:
   ...
   * - throw an error
   */
  let response: PaymentChannelFundResponse = {
    type: ResponseType.Reject,
    result: undefined
  };

  try {
    const message: RequestPaymentChannelFundMessage = {
      app: GEM_WALLET,
